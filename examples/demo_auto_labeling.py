...
from _clip_driver import DataLake, ZeroShotImageClassifier, register_pipline
...
def run():
    ...
    # [1 / 2] Execute 'demo_clip2onnx.py' to generate ONNX model
    ...
    for card in flow_card:
        ...
        logging.info(f">> View at {al.output_dir}")
